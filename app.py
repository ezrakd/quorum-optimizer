    ...
    try:
        ...
        query_class_a = """
            ...
            LEFT JOIN QUORUMDB.SEGMENT_DATA.AGENCY_ADVERTISER aa 
                ON s.AGENCY_ID = aa.ADVERTISER_ID
        ...
        query_class_b = """
            ...
            SELECT 
                c.AGENCY_ID,
                COALESCE(aa.AGENCY_NAME, 'Agency ' || c.AGENCY_ID) as AGENCY_NAME,
                SUM(c.IMPRESSIONS) as IMPRESSIONS,
                SUM(c.STORE_VISITS) as STORE_VISITS,
                COUNT(DISTINCT AGENCY_ID) as ADVERTISER_COUNT,
                'B' as AGENCY_CLASS
            FROM combined c
            LEFT JOIN QUORUMDB.SEGMENT_DATA.AGENCY_ADVERTISER aa ON c.AGENCY_ID = aa.ADVERTISER_ID
            GROUP BY c.AGENCY_ID, aa.AGENCY_NAME
            HAVING SUM(c.IMPRESSIONS) >= 10000 OR SUM(c.STORE_VISITS) >= 100
        """
        ...
        # Combine and sort by impressions
        all_results = results_a + results_b + results_w
